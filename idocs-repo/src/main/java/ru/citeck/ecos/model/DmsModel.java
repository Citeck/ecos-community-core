...
public final class DmsModel {
    ...
    public static final QName PROP_CONTRACT_ENDDATE = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_enddate");
    public static final QName PROP_CONTRACT_SUPPLIER = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_supplier");
    public static final QName PROP_CONTRACT_DATE = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_contractDate");
    public static final QName PROP_CONTRACT_STARTDATE = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_startdate");
    public static final QName PROP_CONTRACT_AUTO_PROLONG = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_autoprolongation");
    public static final QName PROP_CONTRACT_PROLONG_ENDDATE = QName.createQName(DMS_NAMESPACE, "com_citeck_cms_contract_prolongationenddate");
