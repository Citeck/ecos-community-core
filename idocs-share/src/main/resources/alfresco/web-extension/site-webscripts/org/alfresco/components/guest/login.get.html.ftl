...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <@markup id="header">
         ...
         <div class="theme-company-logo ${aboutConfig.getChildValue("css-class")!logo-com}"
                style="background: transparent url(/share/proxy/alfresco/citeck/micro/uiserv/api/theme/active/image/login-logo?cb=${citeckUtils.getCacheBust()}) no-repeat;"></div>
      </@markup>
